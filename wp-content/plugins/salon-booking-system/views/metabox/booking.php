...
?>
<?php echo $booking->getTransactionId() ? '<h5 class="sln-box-title--nu--ter sln-box-title--nu--dark">' . __("Transaction", 'salon-booking-system') . ': <strong>' . $booking->getTransactionId() . '</strong></h5>' : '<h5 class="sln-box-title--nu--ter sln-box-title--nu--dark">' . __("Transaction", 'salon-booking-system') . ': <strong>' . __('n.a.', 'salon-booking-system') . '</strong></h5>' ?>
        </div>
