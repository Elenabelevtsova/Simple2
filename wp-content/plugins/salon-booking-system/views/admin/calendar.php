...
<div class="row" style="display: flex">
	...
	<h2><?php _e('Install our app, is much more easy to use on a mobile device, and it can be used by your workers too.', 'salon-booking-system')?> <a href="https://www.salonbookingsystem.com/salon-booking-system-mobile-app/?utm_source=Free-edition&utm_medium=link-back-end-calendar&utm_campaign=push-to-pro&utm_content=use%20app" target="_blank"  class="sln-notice--action"><?php _e('Read more..', 'salon-booking-system')?></a></h2>
                <button type="button" class="sln-notice__dismiss"><span class="screen-reader-text">Dismiss this notice.</span></button>
	    </div>
	</div>
    <?php endif;?>
