...
class SLN_Wrapper_Booking_Builder
{
    ...
    {
	error_log('SLN booking date/time: ' . $this->getDate() . ' ' . $this->getTime());
	error_log('SLN booking services: ' . print_r($this->data['services'], true));
	error_log('SLN booking settings: ' . print_r(array(
		...
		error_log('SLN booking service id: ' . print_r($bookingService->getService()->getId(), true));
		error_log('SLN booking service attendant enabled: ' . print_r($bookingService->getService()->isAttendantsEnabled(), true));
		error_log('SLN booking service attendant id: ' . print_r($bookingService->getAttendant() ? $bookingService->getAttendant()->getId() : '', true));
