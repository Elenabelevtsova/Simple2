...
class SLN_Action_Ajax_Calendar extends SLN_Action_Ajax_Abstract
{
	...
	$total = 0;
    $nonWorkingTime = ' event-non-working-time';
	...
	$total += $discountAmount;
        ...
        $ret = array(
            ...
            "class"       => $nonWorkingTime? $nonWorkingTime : "event-" . SLN_Enum_BookingStatus::getColor($booking->getStatus()),
        ...
        foreach ($ret['items'] as &$item) {
            ...
            $item['title'] = $this->getBookingServiceTitle($bookingService, $booking);
        }
    ...
    private function getBookingServiceTitle($bookingService, $booking) {
        return $this->plugin->loadView('admin/_calendar_booking_service_title', compact('bookingService', 'booking'));
    }
}