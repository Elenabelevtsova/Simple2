    ...
    protected function buildTimeslots()
    {
        ...
        foreach ($bookings as $booking) {
			...
			@$ret[$time]['service'][$bookingService->getService()->getId()]++;
                    ...
                    if ($bookingService->getService() && $bookingService->getAttendant() && apply_filters('sln_build_timeslots_add_attendant_to_timeslot', true, $time, $bookingService, $booking, $this->bookings)) {
