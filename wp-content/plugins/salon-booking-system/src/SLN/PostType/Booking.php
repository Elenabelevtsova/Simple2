                ...
                case 'booking_actions' :
                    if ( $this->getPlugin()->getSettings()->get('confirmation') && $obj->getStatus(
                        ...
                        echo '<div class="sln-booking-confirmation">';
                            ...
                            echo '<div class="sln-booking-confirmation-success" data-status="' . SLN_Enum_BookingStatus::CONFIRMED . '" data-booking-id="' . $obj->getId() . '" title="' . __('Accept', 'salon-booking-system') . '" data-class="success"></div>';
                            echo '<div class="sln-booking-confirmation-error" data-status="' . SLN_Enum_BookingStatus::CANCELED . '" data-booking-id="' . $obj->getId() . '" title="' . __('Refuse', 'salon-booking-system') . '" data-class="danger"></div>';
                        echo '</div>';
				    }
